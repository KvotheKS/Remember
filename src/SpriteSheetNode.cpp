...
BVNode::BVNode(std::string file, SDL_Rect clip_line, int frameCount, float frameTime, Vec2 scale, bool reverse, bool flipped)
    : SSNode(file, clip_line, frameCount, frameTime, scale, reverse, flipped)
{ rev = false;}
